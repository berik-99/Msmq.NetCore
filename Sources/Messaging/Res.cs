...
internal sealed class Res
{
	...
	//internal Res() => resources = new ResourceManager("MSMQ.Properties.Resources", typeof(Properties.Resources).Assembly);
	...
	private static Res GetLoader()
	{
		...
		{
			Res res = new Res();
			Interlocked.CompareExchange(ref _loader, res, null);
		}
		return _loader;
	}
