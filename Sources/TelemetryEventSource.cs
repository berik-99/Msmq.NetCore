...
internal sealed class TelemetryEventSource : EventSource
{
	...
	internal TelemetryEventSource(string eventSourceName) : base(eventSourceName, (EventSourceSettings)8, telemetryTraits)
	{
	}
	...
	{
		Write(memberName, MeasuresOptions());
	}
	...
	{
		WriteUsageEvent(nameof(MessageQueue));
	}
}
